...
/**
 * The class used for the demonstration of the ObjectMutlistack class and its
 * integration with ValueWrapper class. ObjectMultistack class provides user
 * with standard methods for working with stacks and perform operations such as
 * push, peek or pop in O(1) complexity.
 * 
