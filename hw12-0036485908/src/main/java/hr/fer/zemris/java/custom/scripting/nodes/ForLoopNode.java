...
public class ForLoopNode extends Node {
	...
	public String toString() {
		...
		sb.append("{$ FOR ");
		sb.append(getVariable().asText()).append(" ");
		sb.append(getStartExpression().asText()).append(" ");
		sb.append(getEndExpression().asText()).append(" ");

		if (getStepExpression() != null) {
			sb.append(getStepExpression().asText()).append(" ");
		}
		sb.append(" $}");
